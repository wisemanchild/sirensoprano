...
if (!function_exists('byblos_setup')) :
    function byblos_setup() {
        ...
        load_theme_textdomain('byblos-nlm', get_template_directory() . '/languages');
        ...
        register_nav_menus(array(
            'primary' => __('Primary Menu', 'byblos-nlm'),
        ));
        add_editor_style('');
        ...
        if( ! get_option('byblos-nlm') ) :
            
            add_option('byblos-nlm', byblos_get_options() );
